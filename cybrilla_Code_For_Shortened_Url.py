...
class UrlShortenerService(object):
    ...
    # Declaring local variables for implementation Redis
    redis_srv = None
    ...
    # prefix base_url for our url shortener service
    ...
    def shorten_url(self, long_url):
        ...
        #  url is very longer than 20 chars
        ...
        # encoding shortened_url before saving it
